                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('nilai_perolehan') is-invalid @enderror"
                                    name="nilai_perolehan" value="{{ old('nilai_perolehan', $data->nilai_perolehan) }}" id="nilai_perolehan"
                                    required readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('total') is-invalid @enderror"
                                    name="total" value="{{ old('total', $data->total) }}" id="total" required readonly>
                                @error('total')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-sm-10">
                                <select class="form-control @error('kelompok_aktap_id') is-invalid @enderror"
                                    ...
                                    @foreach ($aktap as $item)
                                        @if (old('kelompok_aktap_id', $data->kelompok_aktap_id) == $item->id)
                            ...
                            <div class="col-sm-10">
                                <select class="form-control @error('data_unit_id') is-invalid @enderror" name="data_unit_id"
                                    ...
                                    @foreach ($units as $unit)
                                        @if (old('data_unit_id', $data->data_unit_id) == $unit->id)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control @error('tanggal_invoice') is-invalid @enderror"
                                    name="tanggal_invoice" value="{{ old('tanggal_invoice', $data->tanggal_invoice) }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('no_inventory') is-invalid @enderror"
                                    value="{{ old('no_inventory', $data->no_inventory) }}" id="no_inventory" required readonly>
                                @error('no_inventory')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control @error('lokasi_id') is-invalid @enderror" name="lokasi_id"
                                    ...
                                    @if (old('lokasi_id', $data->lokasi_id) == $area->id)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control @error('sumber_perolehan_id') is-invalid @enderror"
                                    ...
                                    @if (old('sumber_perolehan_id', $data->sumber_perolehan_id) == $sumber->id)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control @error('golongan_item_id') is-invalid @enderror"
                                    ...
                                    @if (old('golongan_id', $data->golongan_item_id) == $golongan->id)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control @error('jenis_item_id') is-invalid @enderror"
                                    ...
                                    @if (old('jenis_item_id', $data->jenis_item_id) == $tipe->id)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control @error('kelompok_item_id') is-invalid @enderror"
                                    ...
                                    @if (old('kelompok_item_id', $data->kelompok_item_id) == $kelompok->id)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control @error('detailbarang_id') is-invalid @enderror"
                                    ...
                                    @if (old('detailbarang_id', $data->detailbarang_id) == $detail->id)
                ...
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="location" name="location" value="{{ $data->latitude }},{{ $data->longitude }}" required
                                    readonly>
                                <div class="row">
                                    <div class="col-6">
